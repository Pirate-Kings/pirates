...
<sub>
    <i>
        <b>NOTE:</b> If a reference or source material is not attributed properly or not at all, please kindly [raise an issue](https://github.com/Pirate-Kings/pirates/issues/new) so I can properly give credit to their respective authors.
    </i>
</sub>
